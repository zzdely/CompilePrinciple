package me.kareluo.intensify.preview.aspect;
...
public class AspectTest {
    ...
    @Before("execution(* me.kareluo.intensify.image.IntensifyImageView.onDraw(..))")
    ...
    @After("execution(* me.kareluo.intensify.image.IntensifyImageView.onDraw(..))")
