...
public class AspectTest {
    ...
    //@Before("execution(* com.github.piasy.biv.loader.fresco.FrescoImageLoader.loadImage(..))")
    @Before("execution(* com.github.piasy.biv.example.GlideLoaderActivity.onCreate(..))")
    ...
    //@After("execution(* com.github.piasy.biv.loader.fresco.FrescoImageLoader.loadImage(..))")
    @After("execution(* com.github.piasy.biv.example.GlideLoaderActivity.onCreate(..))")
